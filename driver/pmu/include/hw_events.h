 ...
 */
#define HW_EVENTS                                                              \
	X_HW_EVENTS(0, im_recovery_cycles, evt_umask_cmask(0x0d, 0x01, 0))     \
	X_HW_EVENTS(1, ui_any, evt_umask_cmask(0x0e, 0x01, 0))                 \
	X_HW_EVENTS(2, iund_core, evt_umask_cmask(0x9c, 0x01, 0))              \
	X_HW_EVENTS(3, ur_retire_slots, evt_umask_cmask(0xc2, 0x02, 0))        \
	X_HW_EVENTS(4, ca_stalls_mem_any, evt_umask_cmask(0xa3, 0x14, 20))     \
	X_HW_EVENTS(5, ea_bound_on_stores, evt_umask_cmask(0xa6, 0x40, 0))     \
	X_HW_EVENTS(6, ea_exe_bound_0_ports, evt_umask_cmask(0xa6, 0x01, 0))   \
	X_HW_EVENTS(7, ea_1_ports_util, evt_umask_cmask(0xa6, 0x02, 0))        \
	X_HW_EVENTS(8, ea_2_ports_util, evt_umask_cmask(0xa6, 0x04, 0))        \
	X_HW_EVENTS(9, ca_stalls_l3_miss, evt_umask_cmask(0xa3, 0x06, 6))      \
	...
	X_HW_EVENTS(16, l3_miss_data, evt_umask_cmask(0xb0, 0x10, 0))          \
	X_HW_EVENTS(17, tlb_page_walk, evt_umask_cmask(0x08, 0x01, 0))         \
	X_HW_EVENTS(18, l2_wb, evt_umask_cmask(0xf0, 0x40, 0))                 \
	X_HW_EVENTS(19, l2_in_all, evt_umask_cmask(0xf1, 0x07, 0))
// X_HW_EVENTS(null, evt_umask_cmask(0, 0, 0))

#define NR_HW_EVENTS 20
...
#define X_HW_EVENTS(i, name, code)  extern const struct hw_event hw_evt_##name;
HW_EVENTS
#undef X_HW_EVENTS

// #define NR_HW_EVENTS (CTR_HW_EVENTS)
extern uint gbl_nr_hw_events;
